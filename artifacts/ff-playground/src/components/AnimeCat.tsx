    ...
    <div style={{ position: "relative" }}>
        ...
        {isSpeech && (
          ...
          >
            ...
            <div style={{
              ...
              borderTop: "6px solid rgba(0,240,255,0.35)",
            }} />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Body */}
          <ellipse cx="100" cy="150" rx="43" ry="38" fill="rgba(4,12,26,0.88)" stroke="rgba(0,240,255,0.18)" strokeWidth="0.8" />

          {/* Head */}
          <ellipse cx="100" cy="82" rx="40" ry="37" fill="rgba(4,12,26,0.88)" stroke="rgba(0,240,255,0.18)" strokeWidth="0.8" />

          {/* Left ear */}
          <motion.polygon
            points="70,54 78,22 96,52"
            fill="rgba(4,12,26,0.92)"
            stroke="rgba(0,240,255,0.22)" strokeWidth="0.8"
            animate={{ rotate: [0, -5, 0] }}
            style={{ transformOrigin: "78px 48px" }}
            transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut" }}
          />
          <polygon points="75,50 81,32 92,49" fill="rgba(0,240,255,0.07)" />
          ...
          />
          <polygon points="125,50 119,32 108,49" fill="rgba(0,240,255,0.07)" />
          ...
          <motion.ellipse
            ...
            animate={{
              ...
              fill: isSmile || isLaugh ? "rgba(0,240,255,0.9)" : "rgba(210,235,255,0.95)"
            }}
            rx={7} ry={7}
          ...
          {/* Whiskers */}
          <line x1="57" y1="88" x2="89" y2="90" stroke="rgba(0,240,255,0.2)" strokeWidth="0.8" />
          <line x1="57" y1="93" x2="89" y2="92" stroke="rgba(0,240,255,0.2)" strokeWidth="0.8" />
          <line x1="111" y1="90" x2="143" y2="88" stroke="rgba(0,240,255,0.2)" strokeWidth="0.8" />
          <line x1="111" y1="92" x2="143" y2="93" stroke="rgba(0,240,255,0.2)" strokeWidth="0.8" />
          ...
          <AnimatePresence mode="wait">
            ...
            {isSmile && (
              <motion.path
                ...
                fill="none" stroke="rgba(0,240,255,0.85)" strokeWidth="1.6" strokeLinecap="round"
            ...
            {isLaugh && (
              <motion.g key="laugh"
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              >
                <path d="M87 95 Q100 112 113 95" fill="rgba(4,12,26,0.95)" stroke="rgba(0,240,255,0.85)" strokeWidth="1.6" strokeLinecap="round" />
            ...
            {isDance && (
              ...
              >
                <motion.path
                  ...
                  fill="none" stroke="rgba(0,200,220,0.65)" strokeWidth="8" strokeLinecap="round"
                ...
                {[[-20, -30], [20, -25], [-10, -50], [15, -48], [0, -60]].map(([sx, sy], i) => (
                  <motion.text key={i} x={100 + sx} y={70 + sy} fontSize="12" textAnchor="middle"
                    ...
                    fill={i % 2 === 0 ? "rgba(0,240,255,0.9)" : "rgba(160,80,255,0.9)"}
          ...
          {/* Body markings */}
          <ellipse cx="100" cy="152" rx="22" ry="18" fill="rgba(0,240,255,0.04)" stroke="rgba(0,240,255,0.1)" strokeWidth="0.5" />

          {/* Paws */}
          <ellipse cx="72" cy="180" rx="14" ry="8" fill="rgba(4,12,26,0.85)" stroke="rgba(0,240,255,0.14)" strokeWidth="0.6" />
          <ellipse cx="128" cy="180" rx="14" ry="8" fill="rgba(4,12,26,0.85)" stroke="rgba(0,240,255,0.14)" strokeWidth="0.6" />
